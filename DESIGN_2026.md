...
| Feature/Idea | W Priority | Time Est | Note |
|--------------|---------------------------|-----------------|-------|
| Visualizations: weekly stats, progress charts, achievement sharing.           | 8 | 3h | |
...
| Resolution suggestion for 2026                                                | 6 | 2h | |
| Encrypt user data.                                                            | 5 | 3h | |
| Multi-language support.                                                       | 5 | 3h | |
| Integration with calendar to really manage tasks.                             | 5 | 6h | professional step |
| Voice input/output support.                                                   | 4 | 2h| |
...
| Web app front-end to manage tasks outside Telegram.                           | 2 | 30h| |
| backup/export system for user data.                                           | 1 | 2h | |
