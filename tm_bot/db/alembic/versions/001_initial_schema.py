...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('telegram_requested_at_utc', sa.Text(), nullable=True),
        sa.Column('telegram_ready_at_utc', sa.Text(), nullable=True),
        sa.Column('telegram_setup_by_admin_id', sa.Text(), nullable=True),
        sa.Column('created_at_utc', sa.Text(), nullable=False),
        sa.Column('updated_at_utc', sa.Text(), nullable=False),
