...
class LLMHandler:
    ...
    def _initialize_context(self) -> None:
        ...
        self.system_message_planner_prompt = (
            ...
            "7. HANDLE DATES: When user mentions relative dates or times in natural language (e.g., 'tomorrow', 'next week', 'in 2 months', 'فردا' in Persian, 'demain' in French), "
            "EXTRACT the temporal phrase directly from the user's message and use resolve_date(date_text=<extracted_phrase>) to convert to YYYY-MM-DD. "
            "The resolve_date tool accepts natural language phrases in multiple languages. "
            "You have access to the current date and time in the system message - use it to understand relative dates. "
            ...
            "Plan: {\"steps\": [\n"
            "  {\"kind\": \"tool\", \"purpose\": \"Resolve date from user's message\", \"tool_name\": \"resolve_date\", \"tool_args\": {\"date_text\": \"tomorrow\"}},\n"
            "  {\"kind\": \"tool\", \"purpose\": \"Create one-time promise/reminder\", \"tool_name\": \"add_promise\", \"tool_args\": {\"promise_text\": \"call a friend\", \"num_hours_promised_per_week\": 0.0, \"recurring\": false, \"end_date\": \"FROM_TOOL:resolve_date:\"}},\n"
            ...
            "Plan: {\"steps\": [\n"
            "  {\"kind\": \"tool\", \"purpose\": \"Extract and resolve date phrase from Persian message\", \"tool_name\": \"resolve_date\", \"tool_args\": {\"date_text\": \"فردا\"}},\n"
            "  {\"kind\": \"tool\", \"purpose\": \"Create one-time promise for walking\", \"tool_name\": \"add_promise\", \"tool_args\": {\"promise_text\": \"walk for twenty minutes\", \"num_hours_promised_per_week\": 0.0, \"recurring\": false, \"end_date\": \"FROM_TOOL:resolve_date:\"}},\n"
