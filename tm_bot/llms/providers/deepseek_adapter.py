...
class DeepSeekProviderAdapter(ProviderAdapter):
    ...
    def build_role_model(self, role: str, base_config: Dict[str, Any]) -> Any:
        ...
        deepseek_model = str(base_config.get("deepseek_model") or "deepseek-chat")
        deepseek_base_url = str(base_config.get("deepseek_base_url") or "https://api.deepseek.com/v1")
        model = ChatOpenAI(
            openai_api_key=base_config.get("deepseek_api_key", ""),
